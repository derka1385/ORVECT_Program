...
Le [formulaire public et anonyme de retour atelier](https://derka1385.github.io/ORVECT_Program/collecte/) permet de documenter un cas réel sans demander l’identité de l’atelier ou du technicien, puis d’en générer un export JSON structuré transmis à ORVECT par e-mail. Les fichiers reçus se compilent ensuite en JSONL et CSV avec `python3 scripts/compile_workshop_cases.py` ; voir `collecte/README.md`.
